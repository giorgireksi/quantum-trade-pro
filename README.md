...
- Pi's QPRO workspace, agent settings, and persistent sessions live under `.qpro/` in this project. They do not modify or share sessions with other projects opened through the normal Pi CLI, which keep their own project cwd and global agent configuration.
