...
export const TOOLS: ToolDefX[] = [
  ...
  // --- P2: trend extras ---
  { type: "trendangle", label: "Trend angle", icon: "∠", group: "trend", clicks: 2, defaults: { color: "#4c8dff", width: 2, style: "solid", showAngle: true }, schema: [...lineFields, { key: "showAngle", label: "Angle label", kind: "toggle" }], blurb: "Angle between the line and horizontal." },
  { type: "regression", label: "Regression trend", icon: "≋", group: "trend", clicks: 2, defaults: { color: "#4c8dff", width: 2, style: "solid", extend: true }, schema: [...lineFields, { key: "extend", label: "Extend both sides", kind: "toggle" }], blurb: "Linear regression of closes between the two anchors." },
  { type: "flattop", label: "Flat top / bottom", icon: "▱", group: "trend", clicks: 2, defaults: { color: "#35c4e8", width: 1.5, style: "solid", mode: "top", extend: true }, schema: [
      { key: "color", label: "Color", kind: "color" },
  ...
  { type: "crossline", label: "Crossline", icon: "✕", group: "trend", clicks: 2, defaults: { color: "#4c8dff", width: 1.5, style: "dashed" }, schema: lineFields, blurb: "Extended line plus its perpendicular through the first point." },
  // --- pitchforks ---
  { type: "pitchfork", label: "Pitchfork", icon: "⸛", group: "trend", shortcut: "F2", clicks: 3, defaults: { color: "#8b9bb4", width: 1, style: "solid" }, schema: lineFields, blurb: "Median line from the pivot through the midpoint of the two outside points (Andrews)." },
  { type: "schiff", label: "Schiff pitchfork", icon: "⸛", group: "trend", clicks: 3, defaults: { color: "#8b9bb4", width: 1, style: "solid" }, schema: lineFields, blurb: "Schiff variant: median starts at the second point through the midpoint of the other two." },
  // --- gann ---
  { type: "gannfan", label: "Gann fan", icon: "✳", group: "gann", shortcut: "G", clicks: 1, defaults: { color: "#4c8dff", width: 1, style: "solid" }, schema: lineFields, blurb: "Eight angle lines 1/8 → 8/8 from the pivot. Angle grid locks to the chart scale at creation." },
  { type: "gannbox", label: "Gann box", icon: "▣", group: "gann", clicks: 1, defaults: { color: "#4c8dff", width: 1, style: "solid" }, schema: lineFields, blurb: "8×8 square with diagonals. Square locks to the chart scale at creation." },
  // --- shapes ---
  { type: "ellipse", label: "Ellipse", icon: "⬭", group: "shapes", clicks: 2, defaults: { color: "#6999b8", width: 1.5, style: "solid", fill: 0.06 }, schema: [...lineFields, { key: "fill", label: "Fill opacity", kind: "number", min: 0, max: 0.5, step: 0.02 }] },
  { type: "circle", label: "Circle", icon: "○", group: "shapes", clicks: 2, defaults: { color: "#6999b8", width: 1.5, style: "solid", fill: 0.06 }, schema: [...lineFields, { key: "fill", label: "Fill opacity", kind: "number", min: 0, max: 0.5, step: 0.02 }], blurb: "Center + circumference point (ellipse in data space, like TradingView)." },
  { type: "triangle", label: "Triangle", icon: "△", group: "shapes", clicks: 3, defaults: { color: "#6999b8", width: 1.5, style: "solid", fill: 0.08 }, schema: [...lineFields, { key: "fill", label: "Fill opacity", kind: "number", min: 0, max: 0.5, step: 0.02 }] },
  { type: "polyline", label: "Polyline", icon: "⎓", group: "shapes", unbounded: true, defaults: { color: "#4c8dff", width: 2, style: "solid" }, schema: lineFields, blurb: "Click points; Enter or double-click to finish." },
  { type: "brush", label: "Brush", icon: "🖌", group: "shapes", drag: true, defaults: { color: "#4c8dff", width: 3 }, schema: [
      { key: "color", label: "Color", kind: "color" },
  ...
  // --- annotations ---
  { type: "arrow", label: "Arrow", icon: "➤", group: "annotations", shortcut: "A", clicks: 2, defaults: { color: "#4c8dff", width: 2, style: "solid" }, schema: lineFields },
  ...
  { type: "callout", label: "Callout", icon: "💬", group: "annotations", clicks: 1, defaults: { color: "#dbe4f0", text: "callout", size: 12, bg: "#1c2431" }, schema: [
      { key: "text", label: "Text", kind: "multiline" },
      { key: "color", label: "Color", kind: "color" },
      { key: "size", label: "Font px", kind: "number", min: 9, max: 28, step: 1 },
      { key: "bg", label: "Background", kind: "color" },
  ...
  { type: "elliott", label: "Elliott waves", icon: "〰", group: "patterns", clicks: 5, defaults: { color: "#35c4e8", width: 1.5, style: "solid", showLabels: true }, schema: [
      { key: "color", label: "Color", kind: "color" },
      { key: "width", label: "Line width", kind: "number", min: 1, max: 4, step: 1 },
      { key: "style", label: "Style", kind: "select", options: ["solid", "dashed", "dotted"] },
